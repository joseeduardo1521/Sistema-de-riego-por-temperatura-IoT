...
void loop() {
 ...
 Serial.println("Humedad: ");
  ...
  if(t<=27&&valHumsuelo<=20){
     digitalWrite(bombaAgua, LOW);
     delay(4000);
     Serial.println("Bomba activada");
     Firebase.setString(firebaseData, ruta+ "/Mensaje","Sistema de riego activado");
  }else{
    digitalWrite(bombaAgua, HIGH);
    Serial.println("apagado");
    Firebase.setString(firebaseData, ruta+ "/Mensaje","Sistema de riego apagado");
  }
